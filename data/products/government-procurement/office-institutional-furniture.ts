...
export const governmentOfficeInstitutionalFurniture: Product[] = [
  {
    ...
    shortDescription_en: "Desks, workstations, and seating sourced for government and institutional offices.",
    shortDescription_ar: "مكاتب ومحطات عمل ومقاعد يتم توريدها للمكاتب الحكومية والمؤسسية.",
    longDescription_en:
    ...
    features_en: ["Desks, workstations, and task seating", "Sourced to fit your department's layout and headcount"],
    features_ar: ["مكاتب ومحطات عمل ومقاعد", "يتم توريدها بما يناسب مخطط إدارتكم وعدد الموظفين"],
    relatedProductSlugs: ["executive-reception-furniture", "office-partitions-cubicles", "filing-storage-cabinets"],
    catalogues: [
      { id: "office-furniture-systems-datasheet", title_en: "Office Furniture Systems Datasheet", title_ar: "نشرة بيانات أنظمة الأثاث المكتبي", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
  ...
  },
  {
    ...
    shortDescription_en: "Executive desks, meeting tables, and reception furniture for government offices.",
    shortDescription_ar: "مكاتب تنفيذية وطاولات اجتماعات وأثاث استقبال للمكاتب الحكومية.",
    longDescription_en:
    ...
    sectorId: "government-procurement",
    categoryId: "office-institutional-furniture",
    relatedProductSlugs: ["office-furniture-systems", "office-partitions-cubicles"],
    catalogues: [
      { id: "executive-reception-furniture-datasheet", title_en: "Executive & Reception Furniture Datasheet", title_ar: "نشرة بيانات الأثاث التنفيذي وأثاث الاستقبال", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Filing cabinets and secure storage units for institutional records and supplies.",
    shortDescription_ar: "خزائن ملفات ووحدات تخزين آمنة للسجلات والمستلزمات المؤسسية.",
    longDescription_en:
    ...
    sectorId: "government-procurement",
    categoryId: "office-institutional-furniture",
    relatedProductSlugs: ["institutional-furniture", "office-furniture-systems"],
    catalogues: [
      { id: "filing-storage-cabinets-datasheet", title_en: "Filing & Storage Cabinets Datasheet", title_ar: "نشرة بيانات خزائن الملفات والتخزين", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    name_ar: "أثاث مؤسسي",
    shortDescription_en: "Durable furniture for schools, hospitals, and public offices sourced to institutional-grade standards.",
    shortDescription_ar: "أثاث متين للمدارس والمستشفيات والمكاتب العامة، يتم توريده وفق معايير الاستخدام المؤسسي.",
    longDescription_en:
    ...
    sectorId: "government-procurement",
    categoryId: "office-institutional-furniture",
    relatedProductSlugs: ["filing-storage-cabinets", "office-furniture-systems"],
    catalogues: [
      { id: "institutional-furniture-datasheet", title_en: "Institutional Furniture Datasheet", title_ar: "نشرة بيانات الأثاث المؤسسي", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Modular partitions and workstation cubicles for open-plan government offices.",
    shortDescription_ar: "فواصل معيارية ومقصورات محطات عمل للمكاتب الحكومية ذات المخطط المفتوح.",
    longDescription_en:
    ...
    sectorId: "government-procurement",
    categoryId: "office-institutional-furniture",
    relatedProductSlugs: ["office-furniture-systems", "executive-reception-furniture"],
    catalogues: [
      { id: "office-partitions-cubicles-datasheet", title_en: "Office Partitions & Cubicles Datasheet", title_ar: "نشرة بيانات الفواصل والمقصورات المكتبية", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
