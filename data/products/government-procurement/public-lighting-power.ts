...
export const governmentPublicLightingPower: Product[] = [
  {
    ...
    shortDescription_en: "Street lighting poles and fixtures for municipal roads and public spaces.",
    ...
    relatedProductSlugs: ["solar-street-lighting", "public-backup-power-systems"],
    catalogues: [
      { id: "street-public-lighting-systems-datasheet", title_en: "Street & Public Lighting Systems Datasheet", title_ar: "نشرة بيانات أنظمة الإنارة العامة", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
  ...
  },
  {
    ...
    shortDescription_en: "Self-contained solar street lighting for roads without a reliable grid connection.",
    shortDescription_ar: "وحدات إنارة شوارع تعمل بالطاقة الشمسية بشكل مستقل للطرق التي تفتقر لتوصيل كهرباء موثوق.",
    longDescription_en:
    ...
    sectorId: "government-procurement",
    categoryId: "public-lighting-power",
    relatedProductSlugs: ["street-public-lighting-systems", "solar-power-public-facilities"],
    catalogues: [
      { id: "solar-street-lighting-datasheet", title_en: "Solar Street Lighting Datasheet", title_ar: "نشرة بيانات إنارة الشوارع بالطاقة الشمسية", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Standby generators and backup power for government buildings and public facilities.",
    shortDescription_ar: "مولدات احتياطية وطاقة احتياطية للمباني الحكومية والمرافق العامة.",
    longDescription_en:
    ...
    relatedProductSlugs: ["street-public-lighting-systems", "solar-power-public-facilities"],
    catalogues: [
      { id: "public-backup-power-systems-datasheet", title_en: "Backup Power Systems Datasheet", title_ar: "نشرة بيانات أنظمة الطاقة الاحتياطية", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Rooftop and ground-mounted solar power systems for government buildings.",
    ...
    sectorId: "government-procurement",
    categoryId: "public-lighting-power",
    relatedProductSlugs: ["public-backup-power-systems", "solar-street-lighting"],
    catalogues: [
      { id: "solar-power-public-facilities-datasheet", title_en: "Solar Power Systems Datasheet", title_ar: "نشرة بيانات أنظمة الطاقة الشمسية", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Traffic signals, signage, and management systems for municipal roads.",
    ...
    catalogues: [
      { id: "traffic-management-signal-systems-datasheet", title_en: "Traffic Management & Signal Systems Datasheet", title_ar: "نشرة بيانات أنظمة إدارة الإشارات المرورية", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
