...
export const heavyConcreteCompactionEquipment: Product[] = [
  {
    ...
    shortDescription_en: "Concrete mixers for on-site and transit mixing of concrete.",
    ...
    catalogues: [
      { id: "concrete-mixers-datasheet", title_en: "Concrete Mixers Datasheet", title_ar: "نشرة بيانات خلاطات الخرسانة", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
  ...
  },
  {
    ...
    shortDescription_en: "Concrete pumps for placing concrete at height or distance from the mixer.",
    shortDescription_ar: "مضخات خرسانة لصب الخرسانة على ارتفاع أو مسافة من الخلاطة.",
    longDescription_en:
    ...
    catalogues: [
      { id: "concrete-pumps-datasheet", title_en: "Concrete Pumps Datasheet", title_ar: "نشرة بيانات مضخات الخرسانة", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Vibratory rollers for soil and asphalt compaction on road and site works.",
    shortDescription_ar: "رصاصات اهتزازية لدك التربة والأسفلت في أعمال الطرق والمواقع.",
    longDescription_en:
    ...
    catalogues: [
      { id: "vibratory-rollers-datasheet", title_en: "Vibratory Rollers Datasheet", title_ar: "نشرة بيانات الرصاصات الاهتزازية", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Asphalt pavers for laying and finishing road surface courses.",
    ...
    catalogues: [
      { id: "asphalt-pavers-datasheet", title_en: "Asphalt Pavers Datasheet", title_ar: "نشرة بيانات فارشات الأسفلت", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Hydraulic breaker attachments for demolition and rock-breaking work.",
    ...
    relatedProductSlugs: ["concrete-pumps"],
    catalogues: [
      { id: "hydraulic-breakers-datasheet", title_en: "Hydraulic Breakers Datasheet", title_ar: "نشرة بيانات المطارق الهيدروليكية", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
