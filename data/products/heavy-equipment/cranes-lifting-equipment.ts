...
export const heavyCranesLiftingEquipment: Product[] = [
  {
    ...
    shortDescription_en: "Mobile cranes for lifting and placement work on construction and industrial sites.",
    shortDescription_ar: "رافعات متحركة لأعمال الرفع والتموضع في مواقع الإنشاءات والمنشآت الصناعية.",
    longDescription_en:
    ...
    catalogues: [
      { id: "mobile-cranes-datasheet", title_en: "Mobile Cranes Datasheet", title_ar: "نشرة بيانات الرافعات المتحركة", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
  ...
  },
  {
    ...
    shortDescription_en: "Crawler cranes for heavy-lift work on soft or uneven ground.",
    shortDescription_ar: "رافعات زاحفة لأعمال الرفع الثقيل على الأرضيات الطرية أو غير المستوية.",
    longDescription_en:
    ...
    catalogues: [
      { id: "crawler-cranes-datasheet", title_en: "Crawler Cranes Datasheet", title_ar: "نشرة بيانات الرافعات الزاحفة", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Forklifts for material handling in warehouses, yards, and job sites.",
    shortDescription_ar: "رافعات شوكية لمناولة المواد في المستودعات والساحات ومواقع العمل.",
    longDescription_en:
    ...
    catalogues: [
      { id: "forklifts-datasheet", title_en: "Forklifts Datasheet", title_ar: "نشرة بيانات الرافعات الشوكية", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Telehandlers for lifting and placing loads at height and reach on site.",
    shortDescription_ar: "رافعات تلسكوبية لرفع ووضع الأحمال على ارتفاع ومدى بالموقع.",
    longDescription_en:
    ...
    catalogues: [
      { id: "telehandlers-datasheet", title_en: "Telehandlers Datasheet", title_ar: "نشرة بيانات الرافعات التلسكوبية", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Scissor and boom lifts for safe elevated access to work at height.",
    shortDescription_ar: "رافعات مقصية وذات ذراع للوصول الآمن والمرتفع للعمل على ارتفاع.",
    longDescription_en:
    ...
    relatedProductSlugs: ["telehandlers", "mobile-cranes"],
    catalogues: [
      { id: "aerial-work-platforms-datasheet", title_en: "Aerial Work Platforms Datasheet", title_ar: "نشرة بيانات منصات العمل الهوائية", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
