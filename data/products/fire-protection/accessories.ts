...
export const fireProtectionAccessories: Product[] = [
  {
    ...
    shortDescription_en: "Above-ground and underground fire hydrants for site fire water networks.",
    shortDescription_ar: "حنفيات حريق أرضية وتحت أرضية لشبكات مياه الحريق بالموقع.",
    longDescription_en:
    ...
    catalogues: [
      { id: "hydrants-datasheet", title_en: "Hydrants Datasheet", title_ar: "نشرة بيانات حنفيات الحريق", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
  ...
  },
  {
    ...
    shortDescription_en: "Landing valves for wet and dry riser fire-fighting connections.",
    shortDescription_ar: "صمامات إنزال لتوصيلات الأعمدة الصاعدة الرطبة والجافة لمكافحة الحريق.",
    longDescription_en:
    ...
    relatedBrandSlugs: ["naffco", "victaulic"],
    catalogues: [
      { id: "landing-valves-datasheet", title_en: "Landing Valves Datasheet", title_ar: "نشرة بيانات صمامات الإنزال", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Fixed hose reels for first-response fire fighting inside buildings.",
    shortDescription_ar: "بكرات خراطيم ثابتة للاستجابة الأولى لمكافحة الحريق داخل المباني.",
    longDescription_en:
    ...
    catalogues: [
      { id: "fire-hose-reels-datasheet", title_en: "Fire Hose Reels Datasheet", title_ar: "نشرة بيانات بكرات خراطيم الحريق", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Fire-fighting hoses sourced to your required length, diameter, and pressure rating.",
    shortDescription_ar: "خراطيم مكافحة حريق يتم توريدها وفق الطول والقطر وتصنيف الضغط المطلوب.",
    longDescription_en:
    ...
    relatedBrandSlugs: ["naffco"],
    catalogues: [
      { id: "fire-hoses-datasheet", title_en: "Fire Hoses Datasheet", title_ar: "نشرة بيانات خراطيم الحريق", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Certified portable extinguishers for every facility type and fire class.",
    shortDescription_ar: "طفايات حريق محمولة ومعتمدة لجميع أنواع المنشآت وفئات الحريق.",
    longDescription_en:
    ...
    catalogues: [
      { id: "fire-extinguishers-datasheet", title_en: "Fire Extinguishers Datasheet", title_ar: "نشرة بيانات طفايات الحريق", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Emergency and exit lighting for safe evacuation during a power outage.",
    shortDescription_ar: "إضاءة طوارئ ومخارج لإخلاء آمن عند انقطاع التيار الكهربائي.",
    longDescription_en:
    ...
    catalogues: [
      { id: "emergency-lighting-datasheet", title_en: "Emergency Lighting Datasheet", title_ar: "نشرة بيانات إضاءة الطوارئ", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Illuminated exit signage for clear evacuation route guidance.",
    ...
    catalogues: [
      { id: "exit-signs-datasheet", title_en: "Exit Signs Datasheet", title_ar: "نشرة بيانات لافتات الخروج", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
