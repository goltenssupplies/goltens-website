...
export const fireProtectionFireAlarm: Product[] = [
  {
    ...
    shortDescription_en: "Detection and alarm systems for early warning across your facility.",
    shortDescription_ar: "أنظمة كشف وإنذار للتحذير المبكر في جميع أنحاء منشأتكم.",
    longDescription_en:
    ...
    features_en: ["Addressable and conventional panel options", "Smoke, heat, and multi-sensor detectors", "Integrates with building management systems"],
    features_ar: ["خيارات لوحات قابلة للعنونة وتقليدية", "كاشفات دخان وحرارة ومتعددة الاستشعار", "تتكامل مع أنظمة إدارة المباني"],
    specifications: [{ label_en: "Panel type", label_ar: "نوع اللوحة", value: "Addressable / Conventional" }],
    relatedProductSlugs: ["addressable-panels", "conventional-panels", "smoke-detectors"],
    relatedBrandSlugs: ["honeywell", "notifier", "simplex", "morley"],
    catalogues: [
      { id: "fire-alarm-systems-datasheet", title_en: "Fire Alarm Systems Datasheet", title_ar: "نشرة بيانات أنظمة إنذار الحريق", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
  ...
  },
  {
    ...
    shortDescription_en: "Smoke detectors for early fire detection across occupied and plant spaces.",
    shortDescription_ar: "كاشفات دخان للكشف المبكر عن الحريق في المساحات المأهولة ومناطق المعدات.",
    longDescription_en:
    ...
    sectorId: "fire-protection",
    categoryId: "fire-alarm",
    relatedProductSlugs: ["fire-alarm-systems", "heat-detectors", "addressable-panels"],
    relatedBrandSlugs: ["honeywell", "notifier"],
    catalogues: [
      { id: "smoke-detectors-datasheet", title_en: "Smoke Detectors Datasheet", title_ar: "نشرة بيانات كاشفات الدخان", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Fixed and rate-of-rise heat detectors for areas unsuited to smoke detection.",
    shortDescription_ar: "كاشفات حرارة ثابتة ومعدل ارتفاع للمناطق غير المناسبة لكشف الدخان.",
    longDescription_en:
    ...
    sectorId: "fire-protection",
    categoryId: "fire-alarm",
    relatedProductSlugs: ["fire-alarm-systems", "smoke-detectors", "beam-detectors"],
    relatedBrandSlugs: ["honeywell", "notifier"],
    catalogues: [
      { id: "heat-detectors-datasheet", title_en: "Heat Detectors Datasheet", title_ar: "نشرة بيانات كاشفات الحرارة", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Projected-beam smoke detectors for large, open, or high-ceiling spaces.",
    shortDescription_ar: "كاشفات دخان بشعاع موجه للمساحات الكبيرة والمفتوحة وعالية السقف.",
    longDescription_en:
    ...
    catalogues: [
      { id: "beam-detectors-datasheet", title_en: "Beam Detectors Datasheet", title_ar: "نشرة بيانات كاشفات الشعاع", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Addressable fire alarm control panels for precise device-level identification.",
    shortDescription_ar: "لوحات تحكم إنذار حريق قابلة للعنونة لتحديد دقيق على مستوى كل جهاز.",
    longDescription_en:
    ...
    sectorId: "fire-protection",
    categoryId: "fire-alarm",
    relatedProductSlugs: ["fire-alarm-systems", "conventional-panels", "smoke-detectors"],
    relatedBrandSlugs: ["notifier", "simplex", "morley"],
    catalogues: [
      { id: "addressable-panels-datasheet", title_en: "Addressable Panels Datasheet", title_ar: "نشرة بيانات اللوحات القابلة للعنونة", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Conventional fire alarm control panels for zone-based detection.",
    shortDescription_ar: "لوحات تحكم إنذار حريق تقليدية للكشف المعتمد على المناطق.",
    longDescription_en:
    ...
    catalogues: [
      { id: "conventional-panels-datasheet", title_en: "Conventional Panels Datasheet", title_ar: "نشرة بيانات اللوحات التقليدية", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
