...
export const electricalSwitchgearDistribution: Product[] = [
  {
    ...
    shortDescription_en: "LV switchgear and distribution panels for building and facility electrical systems.",
    shortDescription_ar: "لوحات توزيع كهربائية منخفضة الجهد للأنظمة الكهربائية بالمباني والمنشآت.",
    longDescription_en:
    ...
    relatedProductSlugs: ["medium-voltage-switchgear", "distribution-panel-boards"],
    catalogues: [
      { id: "low-voltage-switchgear-datasheet", title_en: "Low Voltage Switchgear Datasheet", title_ar: "نشرة بيانات لوحات التوزيع منخفضة الجهد", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
  ...
  },
  {
    ...
    shortDescription_en: "MV switchgear for primary distribution and substation applications.",
    shortDescription_ar: "لوحات توزيع كهربائية متوسطة الجهد لتطبيقات التوزيع الرئيسي والمحطات الفرعية.",
    longDescription_en:
    ...
    catalogues: [
      { id: "medium-voltage-switchgear-datasheet", title_en: "Medium Voltage Switchgear Datasheet", title_ar: "نشرة بيانات لوحات التوزيع متوسطة الجهد", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Distribution boards for final circuit protection and load distribution.",
    ...
    catalogues: [
      { id: "distribution-panel-boards-datasheet", title_en: "Distribution Boards Datasheet", title_ar: "نشرة بيانات لوحات وصناديق التوزيع", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Ring main units for medium voltage ring distribution networks.",
    shortDescription_ar: "وحدات حلقة رئيسية لشبكات التوزيع الحلقية متوسطة الجهد.",
    longDescription_en:
    ...
    sectorId: "electrical-energy",
    categoryId: "switchgear-distribution",
    relatedProductSlugs: ["medium-voltage-switchgear", "busbar-trunking-systems"],
    catalogues: [
      { id: "ring-main-units-datasheet", title_en: "Ring Main Units Datasheet", title_ar: "نشرة بيانات وحدات الحلقة الرئيسية", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Busbar trunking for high-current power distribution across large facilities.",
    shortDescription_ar: "أنظمة قضبان ناقلة لتوزيع الطاقة عالية التيار عبر المنشآت الكبيرة.",
    longDescription_en:
    ...
    catalogues: [
      { id: "busbar-trunking-systems-datasheet", title_en: "Busbar Trunking Systems Datasheet", title_ar: "نشرة بيانات أنظمة القضبان الناقلة", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
