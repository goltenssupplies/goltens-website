...
export const constructionCementConcreteMaterials: Product[] = [
  {
    ...
    shortDescription_en: "Ordinary and sulfate-resisting Portland cement for construction projects.",
    shortDescription_ar: "أسمنت بورتلاندي عادي ومقاوم للكبريتات لمشروعات الإنشاءات.",
    longDescription_en:
    ...
    catalogues: [
      { id: "portland-cement-datasheet", title_en: "Portland Cement Datasheet", title_ar: "نشرة بيانات الأسمنت البورتلاندي", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
  ...
  },
  {
    ...
    shortDescription_en: "Aggregates and sand for concrete production and site works.",
    ...
    catalogues: [
      { id: "ready-mix-aggregates-datasheet", title_en: "Aggregates & Sand Datasheet", title_ar: "نشرة بيانات الركام والرمل", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Concrete blocks and bricks for structural and partition walling.",
    ...
    catalogues: [
      { id: "concrete-blocks-bricks-datasheet", title_en: "Concrete Blocks & Bricks Datasheet", title_ar: "نشرة بيانات البلوك والطوب الخرساني", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Admixtures that modify concrete's workability, strength, or curing time.",
    shortDescription_ar: "إضافات تعدّل قابلية تشغيل الخرسانة أو مقاومتها أو زمن معالجتها.",
    longDescription_en:
    ...
    catalogues: [
      { id: "concrete-admixtures-datasheet", title_en: "Concrete Admixtures Datasheet", title_ar: "نشرة بيانات إضافات الخرسانة", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Precast concrete elements for faster, factory-controlled site installation.",
    shortDescription_ar: "عناصر خرسانية جاهزة للتركيب الأسرع والمُصنّع بجودة مضبوطة بالموقع.",
    longDescription_en:
    ...
    catalogues: [
      { id: "precast-concrete-products-datasheet", title_en: "Precast Concrete Products Datasheet", title_ar: "نشرة بيانات المنتجات الخرسانية الجاهزة", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
