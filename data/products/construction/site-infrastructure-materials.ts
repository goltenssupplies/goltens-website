...
export const constructionSiteInfrastructureMaterials: Product[] = [
  {
    ...
    shortDescription_en: "Sanitary ware and bathroom fittings for residential and institutional projects.",
    shortDescription_ar: "أدوات صحية وتجهيزات حمامات للمشروعات السكنية والمؤسسية.",
    longDescription_en:
    ...
    relatedProductSlugs: ["piping-systems-pvc-hdpe", "plumbing-fittings-valves"],
    catalogues: [
      { id: "sanitary-ware-fittings-datasheet", title_en: "Sanitary Ware & Bathroom Fittings Datasheet", title_ar: "نشرة بيانات الأدوات الصحية وتجهيزات الحمامات", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
  ...
  },
  {
    ...
    shortDescription_en: "Piping systems for water supply, drainage, and utility networks.",
    ...
    sectorId: "construction",
    categoryId: "site-infrastructure-materials",
    relatedProductSlugs: ["plumbing-fittings-valves", "manhole-covers-drainage"],
    catalogues: [
      { id: "piping-systems-pvc-hdpe-datasheet", title_en: "Piping Systems Datasheet", title_ar: "نشرة بيانات أنظمة المواسير", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Plumbing fittings and connectors for water supply and drainage installations.",
    ...
    catalogues: [
      { id: "plumbing-fittings-valves-datasheet", title_en: "Plumbing Fittings Datasheet", title_ar: "نشرة بيانات تجهيزات السباكة", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Manhole covers and drainage products for site and road infrastructure.",
    shortDescription_ar: "أغطية غرف تفتيش ومنتجات صرف لبنية المواقع والطرق التحتية.",
    longDescription_en:
    ...
    sectorId: "construction",
    categoryId: "site-infrastructure-materials",
    relatedProductSlugs: ["piping-systems-pvc-hdpe", "road-construction-materials"],
    catalogues: [
      { id: "manhole-covers-drainage-datasheet", title_en: "Manhole Covers & Drainage Products Datasheet", title_ar: "نشرة بيانات أغطية غرف التفتيش ومنتجات الصرف", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Materials for road construction and site works, including asphalt and geotextiles.",
    shortDescription_ar: "مواد لإنشاء الطرق وأعمال المواقع، تشمل الأسفلت والجيوتكستايل.",
    longDescription_en:
    ...
    catalogues: [
      { id: "road-construction-materials-datasheet", title_en: "Road Construction Materials Datasheet", title_ar: "نشرة بيانات مواد إنشاء الطرق", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
