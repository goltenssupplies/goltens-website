...
export const constructionStructuralWaterproofingMaterials: Product[] = [
  {
    ...
    shortDescription_en: "Reinforcement steel bars for structural concrete works.",
    ...
    catalogues: [
      { id: "reinforcement-steel-rebar-datasheet", title_en: "Reinforcement Steel Datasheet", title_ar: "نشرة بيانات حديد التسليح", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
  ...
  },
  {
    ...
    shortDescription_en: "Structural steel sections for framing and load-bearing construction elements.",
    shortDescription_ar: "مقاطع حديد إنشائي لأعمال الهيكل والعناصر الحاملة للأحمال.",
    longDescription_en:
    ...
    sectorId: "construction",
    categoryId: "structural-waterproofing-materials",
    relatedProductSlugs: ["reinforcement-steel-rebar", "waterproofing-membranes"],
    catalogues: [
      { id: "structural-steel-sections-datasheet", title_en: "Structural Steel Sections Datasheet", title_ar: "نشرة بيانات مقاطع الحديد الإنشائي", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Waterproofing membranes for roofs, foundations, and wet-area protection.",
    shortDescription_ar: "أغشية عزل مائي لحماية الأسطح والأساسات والمناطق الرطبة.",
    longDescription_en:
    ...
    catalogues: [
      { id: "waterproofing-membranes-datasheet", title_en: "Waterproofing Membranes Datasheet", title_ar: "نشرة بيانات أغشية العزل المائي", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Thermal insulation boards for building envelope energy performance.",
    ...
    sectorId: "construction",
    categoryId: "structural-waterproofing-materials",
    relatedProductSlugs: ["waterproofing-membranes", "structural-steel-sections"],
    catalogues: [
      { id: "thermal-insulation-boards-datasheet", title_en: "Thermal Insulation Boards Datasheet", title_ar: "نشرة بيانات ألواح العزل الحراري", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Sealants and expansion joints for weatherproofing and structural movement control.",
    shortDescription_ar: "مواد سد وفواصل تمدد لعزل العوامل الجوية والتحكم في الحركة الإنشائية.",
    longDescription_en:
    ...
    sectorId: "construction",
    categoryId: "structural-waterproofing-materials",
    relatedProductSlugs: ["waterproofing-membranes", "reinforcement-steel-rebar"],
    catalogues: [
      { id: "construction-sealants-datasheet", title_en: "Construction Sealants Datasheet", title_ar: "نشرة بيانات مواد السد وفواصل التمدد", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "available",
    quoteEnabled: true,
