...
export const globalSpartsPartsOemSourcing: Product[] = [
  {
    ...
    shortDescription_en: "OEM replacement parts sourced against your equipment's original part number.",
    shortDescription_ar: "قطع غيار بديلة أصلية يتم توريدها وفق رقم القطعة الأصلي لمعداتكم.",
    longDescription_en:
    ...
    relatedProductSlugs: ["non-standard-hard-to-find-items", "obsolete-parts-sourcing"],
    catalogues: [
      { id: "oem-replacement-parts-datasheet", title_en: "OEM Replacement Parts Sourcing Overview", title_ar: "نظرة عامة على توريد قطع الغيار الأصلية", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
  ...
  },
  {
    ...
    shortDescription_en: "Custom-manufactured components sourced to your drawing or sample.",
    shortDescription_ar: "مكونات مصنّعة حسب الطلب يتم توريدها وفق مخططاتكم أو عينتكم.",
    longDescription_en:
    ...
    sectorId: "global-sourcing",
    categoryId: "spare-parts-oem-sourcing",
    relatedProductSlugs: ["oem-replacement-parts", "spare-parts-all-categories"],
    catalogues: [
      { id: "custom-manufactured-components-datasheet", title_en: "Custom-Manufactured Components Overview", title_ar: "نظرة عامة على المكونات المصنّعة حسب الطلب", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "on-request",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Spare parts sourcing across every GOLTENS supply category, not only fixed catalog items.",
    shortDescription_ar: "توريد قطع غيار عبر جميع فئات التوريد لدى GOLTENS، وليس فقط الأصناف المدرجة في الكتالوج.",
    longDescription_en:
    ...
    sectorId: "global-sourcing",
    categoryId: "spare-parts-oem-sourcing",
    relatedProductSlugs: ["oem-replacement-parts", "custom-manufactured-components"],
    catalogues: [
      { id: "spare-parts-all-categories-datasheet", title_en: "Spare Parts Sourcing Overview", title_ar: "نظرة عامة على توريد قطع الغيار", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "on-request",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Sourcing support for items that don't fit a standard catalog listing.",
    shortDescription_ar: "دعم توريد للأصناف التي لا تندرج ضمن قوائم الكتالوج القياسية.",
    longDescription_en:
    ...
    catalogues: [
      { id: "non-standard-hard-to-find-items-datasheet", title_en: "Non-Standard Items Sourcing Overview", title_ar: "نظرة عامة على توريد الأصناف غير القياسية", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "on-request",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Sourcing support for parts no longer produced by the original manufacturer.",
    shortDescription_ar: "دعم توريد للقطع التي لم تعد الجهة المصنّعة الأصلية تنتجها.",
    longDescription_en:
    ...
    sectorId: "global-sourcing",
    categoryId: "spare-parts-oem-sourcing",
    relatedProductSlugs: ["non-standard-hard-to-find-items", "spare-parts-all-categories"],
    catalogues: [
      { id: "obsolete-parts-sourcing-datasheet", title_en: "Obsolete Parts Sourcing Overview", title_ar: "نظرة عامة على توريد القطع المتوقفة", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "on-request",
    quoteEnabled: true,
