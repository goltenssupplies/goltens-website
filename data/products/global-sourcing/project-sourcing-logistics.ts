...
export const globalProjectSourcingLogistics: Product[] = [
  {
    ...
    shortDescription_en: "Coordinated equipment packages sourced and delivered as one turnkey scope.",
    shortDescription_ar: "حزم معدات منسّقة يتم توريدها وتسليمها كنطاق واحد جاهز.",
    longDescription_en:
    ...
    relatedProductSlugs: ["certification-compliance-sourcing", "export-import-logistics-support"],
    catalogues: [
      { id: "turnkey-equipment-packages-datasheet", title_en: "Turnkey Equipment Packages Overview", title_ar: "نظرة عامة على حزم المعدات الجاهزة", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
  ...
  },
  {
    ...
    shortDescription_en: "Sourcing coordinated around the specific certification requirements your project needs.",
    shortDescription_ar: "توريد منسّق وفق متطلبات الشهادات المحددة التي يحتاجها مشروعكم.",
    longDescription_en:
    ...
    sectorId: "global-sourcing",
    categoryId: "project-sourcing-logistics",
    relatedProductSlugs: ["turnkey-equipment-packages", "emergency-urgent-procurement"],
    catalogues: [
      { id: "certification-compliance-sourcing-datasheet", title_en: "Certification-Driven Sourcing Overview", title_ar: "نظرة عامة على التوريد وفق الشهادات", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "on-request",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Expedited sourcing support for time-critical procurement requests.",
    ...
    sectorId: "global-sourcing",
    categoryId: "project-sourcing-logistics",
    relatedProductSlugs: ["export-import-logistics-support", "custom-sourcing-requests"],
    catalogues: [
      { id: "emergency-urgent-procurement-datasheet", title_en: "Emergency Procurement Overview", title_ar: "نظرة عامة على التوريد الطارئ", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "on-request",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "Logistics support coordinated with the products we source for your project.",
    ...
    relatedProductSlugs: ["turnkey-equipment-packages", "emergency-urgent-procurement"],
    catalogues: [
      { id: "export-import-logistics-support-datasheet", title_en: "Export & Import Logistics Overview", title_ar: "نظرة عامة على لوجستيات التصدير والاستيراد", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "on-request",
    quoteEnabled: true,
  },
  {
    ...
    shortDescription_en: "A catch-all sourcing category for any product not listed elsewhere on the site.",
    shortDescription_ar: "فئة توريد شاملة لأي منتج غير مدرج في مكان آخر بالموقع.",
    longDescription_en:
    ...
    sectorId: "global-sourcing",
    categoryId: "project-sourcing-logistics",
    relatedProductSlugs: ["certification-compliance-sourcing", "emergency-urgent-procurement"],
    catalogues: [
      { id: "custom-sourcing-requests-datasheet", title_en: "Custom Sourcing Requests Overview", title_ar: "نظرة عامة على طلبات التوريد المخصصة", kind: "datasheet", fileType: "pdf", language: "en", fileUrl: null },
    ],
    images: [],
    availability: "on-request",
    quoteEnabled: true,
